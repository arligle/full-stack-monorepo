...
export const resource = pgTable("resource", {
	...
	(table) => {
		return {
			name_key: uniqueIndex("resource_name_key"),
			parentId_fkey: index("resource_parentId_fkey"),
...
export const role_permission = pgTable("role_permission", {
	...
	(table) => {
		return {
			resourceId_fkey: index("role_permission_resourceId_fkey"),
			roleId_fkey: index("role_permission_roleId_fkey"),
		}
	});
...
export const role = pgTable("role", {
	...
	(table) => {
		return {
			name_key: uniqueIndex("role_name_key"),
			profileId_key: uniqueIndex("role_profileId_key"),
		}
	});
...
export const user_permissions = pgTable("user_permissions", {
	...
	(table) => {
		return {
			resourceId_fkey: index("user_permissions_resourceId_fkey"),
		}
	});
...
export const user_role = pgTable("user_role", {
	...
	(table) => {
		return {
			roleId_fkey: index("user_role_roleId_fkey"),
			userId_key: uniqueIndex("user_role_userId_key"),
		}
	});
